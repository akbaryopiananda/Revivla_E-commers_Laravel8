    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-8">
                ...
                <form action="/updateproduct/{{ $data->id }}" method="POST" id="updateproduct" enctype="multipart/form-data">
                    @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="deskripsi" value="{{ $data->deskripsi }}" class="form-control" id="">
                            </div>
                            <div class="form-group">
                                <label for="harga">Harga</label>
                                <input type="text"  name="harga" value="{{ $data->harga }}" class="form-control" id="">
                            </div>
                            <div class="form-group">
                                <label for="stok">Stok</label>
                                <input type="text"  name="stok" value="{{ $data->stok }}" class="form-control" id="">
                            </div>
