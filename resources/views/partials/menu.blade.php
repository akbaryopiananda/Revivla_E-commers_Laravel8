        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="/user" class="nav-link {{ Request::is('user') ? 'active' : '' }}">
                    ...
                    <p>
                        Hi, {{ Auth::user()->name }} {{-- <span class="badge badge-info right">2</span> --}}
                    </p>
                </a>
            </li>
            <hr style="color: white"> @if (auth()->user()->level =="user")
            <li class="nav-item">
                <a href="/" class="nav-link">
                    <i class="fas fa-chevron-circle-left"></i>
                    <p>
                        Kembali Belanja {{-- <span class="badge badge-info right">2</span> --}}
                    </p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="/product" class="nav-link {{ Request::is('product') ? 'active' : '' }}">
                    ...
                    <p>
                        Product {{-- <span class="badge badge-info right">2</span> --}}
                    </p>
                </a>
            </li>
            <li class="nav-item">
                <a href="/category" class="nav-link {{ Request::is('category') ? 'active' : '' }}">
                    ...
                    <p>
                        Category {{-- <span class="badge badge-info right">2</span> --}}
                    </p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="/customer" class="nav-link {{ Request::is('customer') ? 'active' : '' }}">
                    ...
                    <p>
                        Daftar Customer {{-- <span class="badge badge-info right">2</span> --}}
                    </p>
                </a>
            </li>
            @endif @if (auth()->user()->level =="user")
            <li class="nav-item">
